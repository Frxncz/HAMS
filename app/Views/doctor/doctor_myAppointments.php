...
<head>
  ...
  <link rel="stylesheet" href="/HAMS/public/css/doctor/doctor_myAppointments.css" />
...
<body>
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <div id="appointmentModal" class="modal" aria-hidden="true">
        <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
          ...
          <div style="margin-top:16px">
            <form id="modalAcceptForm" method="post" action="/HAMS/public/actions/doctor/update_appointment_status.php" style="display:inline">
            ...
            <form id="modalDeclineForm" method="post" action="/HAMS/public/actions/doctor/update_appointment_status.php" style="display:inline">
      ...
      <nav class="menu">
        ...
        <a href="./doctor_myAppointments.php" class="menu-item active">
          <img src="/HAMS/public/assets/icons/patientsDashboard/findDoctor.svg" alt="appointment icon">
          My Appointments
        </a>
        <a href="./doctor_mySessions.php" class="menu-item">
          <img src="/HAMS/public/assets/icons/patientsDashboard/myConsultation.svg" alt="sessions icon">
          My Sessions
        </a>
          ...
          <?php foreach ($appointments as $a): ?>
            <div class="appointment-card">
              ...
              <div class="card-details">
                <p><img src="/HAMS/public/assets/icons/doctorDashboard/date.svg" alt="date"> <?php echo htmlspecialchars($a['appt_date']); ?></p>
                <p><img src="/HAMS/public/assets/icons/doctorDashboard/time.svg" alt="time"><?php echo htmlspecialchars($a['appt_time']); ?></p>
                <p><img src="/HAMS/public/assets/icons/doctorDashboard/person.svg" alt="person">Patient ID: <?php echo htmlspecialchars($a['patient_id']); ?></p>
              </div>
    ...
    >View Details</button>
                ...
                ?>
                <form method="post" action="/HAMS/public/actions/doctor/update_appointment_status.php" style="display:inline">
  ...
  <script src="/HAMS/public/js/doctor/doctor_myAppointments.js"></script>
</body>
</html>
