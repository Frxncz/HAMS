...
<head>
  ...
  <link rel="stylesheet" href="/HAMS/public/css/doctor/doctor_mySession.css" />
    ...
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a href="./doctor_myAppointments.php" class="menu-item">
          <img src="/HAMS/public/assets/icons/patientsDashboard/findDoctor.svg" alt="appointments icon">
          My Appointments
        </a>
              ...
              <div class="session-card">
                ...
                <div class="session-details">
                  <div class="detail-item">
                    <img src="/HAMS/public/assets/icons/patientsDashboard/date.svg" alt="calendar icon">
                    <span><?php echo htmlspecialchars($s['appt_date']); ?></span>
                  </div>

                  <div class="detail-item">
                    <img src="/HAMS/public/assets/icons/patientsDashboard/time.svg" alt="clock icon">
                  ...
                  <div id="sessionReschedModal" class="modal" aria-hidden="true">
                    <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="rmTitle">
                      ...
                      <form method="post" action="/HAMS/public/actions/doctor/reschedule_appointment.php">
                  ...
                  <script src="/HAMS/public/js/doctor/doctor_mySessions.js"></script>
                </div>
