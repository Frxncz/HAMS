<?php
  ...
  include_once __DIR__ . '/../../Models/db_connect.php';
...
<head>
  ...
  <link rel="stylesheet" href="/HAMS/public/css/patient/patient_settings.css" />
  ...
  <div class="container">
    ...
    <main class="main-content">
      ...
      <section class="settings-section">
        ...
        <form action="/HAMS/public/actions/patient/update_profile.php" method="POST">
          <div class="form-row">
          ...
          <!-- Phone number removed from account settings per UI update -->
