...
<head>
  ...
  <link rel="stylesheet" href="/HAMS/public/css/patient/patient_myConsultation.css" />
  <link rel="stylesheet" href="/HAMS/public/css/global.css" />
  <link rel="stylesheet" href="/HAMS/public/css/sidebar.css" />
  <script src="/HAMS/public/js/patient/patient_myConsultation.js"></script>
  ...
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <button class="logout-btn" onclick="window.location.href='/HAMS/public/actions/auth/logout.php'">
        <img src="/HAMS/public/assets/icons/patientsDashboard/logout.svg" alt="logout icon"> Log out
      </button>
            <nav class="menu">
...
<div id="editModal" class="modal-backdrop">
  <div class="modal">
    ...
    <form id="editForm" method="POST" action="/HAMS/public/actions/patient/update_appointment.php">
